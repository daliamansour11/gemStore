...
Future<void> initializeDependencies() async {
  ...
  s1.registerSingleton<GetFeaturedProductsUseCase>(GetFeaturedProductsUseCase(s1()));

  //Featured Cubit (or Bloc)
  s1.registerSingleton<FeaturedProductsCubit>(FeaturedProductsCubit(s1())); // Products BLoC
