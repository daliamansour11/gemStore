...
class _DrawerFilterState extends State<DrawerFilter> {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      Padding(
        padding:
            const EdgeInsets.only(left: 27.0, right: 31, top: AppPadding.p55),
        child: Text(
          'Price',
      ...
      Padding(
        padding: const EdgeInsets.only(
            left: AppPadding.p28, top: AppPadding.p40, bottom: AppPadding.p24),
        child: Text(
          'Color',
          style: appTheme().textTheme.titleMedium,
        ),
      ...
      Padding(
        padding:
            const EdgeInsets.only(left: AppPadding.p28, top: AppPadding.p24),
        child: Row(
          children: List.generate(5, (index) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                margin:
                    const EdgeInsets.only(right: 8), // Spacing between items
                decoration: BoxDecoration(
                  color: isSelected
                      ? ColorsManger.dark
      ...
      Padding(
        padding:
            const EdgeInsets.only(left: AppPadding.p28, top: AppPadding.p31),
        child: Text(
          'Category',
          style: appTheme().textTheme.titleMedium,
        ),
      ...
      Padding(
        padding: const EdgeInsets.symmetric(
            horizontal: AppPadding.p28, vertical: 15),
        child: DropdownButtonFormField<String>(
          ...
          decoration: InputDecoration(
              ...
              contentPadding: const EdgeInsets.symmetric(
                  horizontal: 10, vertical: 12), // Padding inside box
              border: OutlineInputBorder(
                borderRadius: BorderRadius.circular(15), // Rounded border
                borderSide: BorderSide(
                    color: ColorsManger.grey.withOpacity(.78),
                    width: 2), // Black border
              ),
              enabledBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(15),
                borderSide: BorderSide(
                    color: ColorsManger.grey.withOpacity(.78), width: 2),
              ),
      ...
      Padding(
        padding:
            const EdgeInsets.only(left: AppPadding.p28, top: AppPadding.p16),
        child: Wrap(
          ...
          children: selectedDiscounts.map((discount) {
            return Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(
                    color: ColorsManger.dark, width: 1), // Black border
                  ...
                  GestureDetector(
                    ...
                    child: IconButton(
                      ...
                      icon: const Icon(Icons.close,
                          color: ColorsManger.dark, size: 14),
                    ),
                  ),
                ],
              ),
      ...
      Padding(
        padding:
            const EdgeInsets.only(top: AppPadding.p55, bottom: AppPadding.p40),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Padding(
