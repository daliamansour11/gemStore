 ...
 class _SearchResultState extends State<SearchResult> {
   ...
   List<Product> products = [
     ...
     Product(
       ...
       rating: 4.9,
       description: "Comfortable and stylish sportswear set.", oldPrice: 99.99,
     ),
        ...
        Text(widget.product.name,
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 5),
                            Text("${widget.product.oldPrice.toDouble()}",
                        ...
                        Row(
                          children: [
                            Icon(Icons.star, color: ColorsManger.ratingColor, size: 16),
                            Icon(Icons.star, color: ColorsManger.ratingColor, size: 16),
                              Icon(Icons.star, color: ColorsManger.ratingColor, size: 16),
                               Icon(Icons.star, color: ColorsManger.ratingColor, size: 16),
                             SizedBox(width: 4),
